...
from Communication.adapters.external_services.can_camera_controller_adapter import CanCameraControllerAdapter
from Communication.adapters.external_services.can_telemetry_controller_adapter import CanTelemetryControllerAdapter
from Communication.adapters.external_services.can_wheels_controller_adapter import CanWheelsControllerAdapter
...
def build_container(config_path: Optional[str] = None) -> HexContainer:
