...
class CommunicationModuleContainer(containers.DeclarativeContainer):
    ...
    dvr_link = providers.Factory(HikvisionDvrLink, url='http://192.168.100.64:80', user="admin", password="inspection24", dir="/home/dcabrera/Pictures")
    ...
    serial_conf = providers.Factory(SerialConfig, port='', baudrate=9600, timeout=None)
